...
public class OrderDAO extends MyDAO {
    ...
    public void insertOrder(int userId, int itemId, int quantity, double price, String orderDate) {
        String xSql = "INSERT INTO Orders (user_id, order_date , status, item_id, quantity, price) VALUES (?, ?, ?, ?, ?, ?)";
        try {
...
String xSql = "SELECT o.user_id, o.status, SUM(o.quantity) as total_quantity, o.price, "
    ...
    public static void main(String[] args) {
        ...
        List<MenuItemJoinOrder> l = o.getOrderListByUserId(22);
        if (l.isEmpty()) {
